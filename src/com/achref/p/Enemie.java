...
public class Enemie extends Personnage implements Runnable{
	...
	public Enemie(int x, int y) {
		...
		this.icoTortue = new ImageIcon(getClass().getResource("/images/AbArretGauche.png"));
