...
2)en deuxième lieu le joueur doit entrer un mot pour le trouvai , le moit
...
j avais utiliser la liste chaine pour manipuler l'objet Alphabet dans le jeu(ajouter supprimer un alphabet dans la scene )
****************
